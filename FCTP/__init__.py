...
class fctp(ABC):
    ...
    def get_flow( self, ij=None, arc=None ):
        ...
        """
        if not ij is None: return api.get_flow( ij[0], ij[0] )
    ...
    def get_status( self, ij=None, arc=None ):
        ...
        """
        if not ij is None: return api.get_status( ij[0],ij[0] )
    ...
    def get_cost_sav( self, ij=None, arc=None ):
        ...
        """
        if not ij is None: return api.get_cost_sav( ij[0], ij[0])
    ...
    def solve( self ):
        ...
        if imp_meth == param.ls:
            ...
            for _ in range(nruns):
                self.history=None
                if imp_meth==param.msls: self.msls()
                elif imp_meth==param.ils: self.ils()
                elif imp_meth==param.sa: self.sa()
                elif imp_meth==param.sa_osman: self.Osman_sa()
                else: break 
